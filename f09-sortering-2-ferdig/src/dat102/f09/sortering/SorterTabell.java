...
public class SorterTabell {
    ...
    flettesortering(T[] a, T[] tempTab, int forste, int siste) {
        ...
        if (forste == siste) { // kan også skrive forste >= siste
            /*
        ...
        // Er også mulig å skrive

        // basis: gjer ingenting

        // if (forste < siste) {
            // kode i else-del ovanfor
        // }
    }
    ...
    public static <T extends Comparable<? super T>> void kvikksorter(T[] a, int forste, int siste) {
        ...
        // På same måte som for kvikksortering kunne vi skrive
        //  if (siste - forste + 1 >= MIN_GRENSE)7
            // kode i else-del
        // }
